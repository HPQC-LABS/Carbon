...
$^{12}$C & C$^+\left(2^{2}P\right)\leftarrow~$C$\left(2^{3}P\right)$ & 90~833&008(009) & \multicolumn{2}{c}{\cite{Haris2017}} & \textcolor{red}{{90~832.014}}  & - & 0.994 &  &Experiment\tabularnewline[2mm]
\hline 
\end{tabular*}
\end{table*}
\par\end{center}
