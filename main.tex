...
\begin{center}
\begin{table}
\caption{\label{tab:Summary}Summary of our main result. The uncertainty in the non-relativistic clamped-point-nucleus (NR-CPN) energy }comes from using two different basis set extrapolation formulas. The X2C }
