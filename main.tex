...
\end{document}%% LyX 2.2.2 created this file.  For more info, see http://www.lyx.org/.
...
\begin{tabular*}{1\columnwidth}{@{\extracolsep{\fill}}lllr@{\extracolsep{0pt}.}l}
\hline
\noalign{\vskip2mm}
 & Hamiltonian & Energy in cm$^{-1}$ & {\small \multicolumn{2}{c}{(Obs - Calc)} in cm$^{-1}$}\tabularnewline[2mm]
\hline
\hline
\noalign{\vskip2mm}
...
\hline
\noalign{\vskip2mm}
Present  & Total theory & \textcolor{red}{90~832.301(810)} & 0&707\tabularnewline[2mm]
\hline
\noalign{\vskip2mm}
