...
\hline 
\noalign{\vskip2mm}
H & H$^+\left(1^1S\right)\leftarrow~$H$\left(1^2S\right)$ &  &  & 109~678.771~743~07(10) \footnote{This number can be found in Table III of \cite{RevModPhys.88.035009} but it is based on }\footnote{This number can be found in Table III of \cite{RevModPhys.88.035009} but it is based on }\footnote{This number can be found in Table III of \cite{RevModPhys.88.035009} but it is based on } &  &  &  & Theory \tabularnewline
    $^{4}$He & He$^+\left(1^2S\right)\leftarrow~$He$\left(1^1S\right)$ & 198~310&666~37(2) & \multicolumn{2}{c}{\cite{Kandula2011}}  & 198~310.665~07(1) & \cite{Pachucki2017}  & -0.001~3 & 65.0 & Theory \tabularnewline
