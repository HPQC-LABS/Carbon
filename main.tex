...
agreement with experiment. Table \ref{tab:variational bounds} shows that the method used for the smaller atoms up to boron has not had success for carbon.  
...
in any experiment to date. The value for carbon of \textcolor{blue}{90~832.301034(81002)}\,cm$^{-1}$ was calculated in the present work.}
...
$^{12}$C & C$^+\left(2^{2}P\right)\leftarrow~$C$\left(2^{3 }P\right)$ & 90~833&11(10) & \multicolumn{2}{c}{} & \textcolor{blue}{90~8332.008034(009802)} &  & 1.076 & 11.08 & Experiment\tabularnewline[2mm]
\hline 
\end{tabular*}
\end{table*}
\par\end{center}
