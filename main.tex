    ...
    total non-relativistic electronic energies. For H, the energy is exact. VO stands for variational optimization (parameters
    in a wavefunction ansatz are optimized to yield the lowest
    energy). Hylleraas-Log indicates the use of Hylleraas functions
    supplemented with auxiliary log functions, and ECG($N$) stands for  explicitly correlated Gaussian ansatz with $N$ optimizable parameters. FN-DMC stands for fixed-node diffusion Monte Carlo. The uncertainty in the FCIQMC energy is the uncertainty ....... do basis set extrapolation}
    ...
    \hline
    \noalign{\vskip2mm}
    NR-CPN &  & 90~863&03737(80000) & \multicolumn{2}{c}{}\tabularnewline
    X2C{\footnotesize{}} &  & -30&023(050050) & \multicolumn{2}{c}{}\tabularnewline
    \multicolumn{2}{l}{\hspace{-0.75mm}Breit \& QED} & -0&5\multicolumn{2}{c}{} & \tabularnewline
     DBOC &  & -0&275 & \multicolumn{2}{c}{}\tabularnewline
    \noalign{\vskip2mm}
    \hline
    \noalign{\vskip2mm}
    Total (theory)  & Present & \textcolor{red} {90~832}&\textcolor{red}{244014} & \qquad  -0&777994\tabularnewline[2mm]
    \hline
    \noalign{\vskip2mm}
    ...
    \hline
    \noalign{\vskip2mm}
    Mean ($\sigma$) &  & -37&844~521~4 & -37&430~519~0 & 90~863&037\tabularnewline[2mm]
    \hline
    \end{tabular*}
    \end{table}
    \par\end{center}
    ...
    Diagonal Born-Oppenheimer breakdown corrections (DBOC) to the clamped nucleus approximation were calculated using $\tt{CFOUR}$, with $\tt{MRCC}$ used for the coupled-cluster part. Our value of -0.2750\,cm$^{-1}$ is more than tripdouble the value of -0.08\,cm$^{-1}$ estimated in \cite{Klopper2010}, due to including higher levels of correlation.
