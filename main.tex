    ...
    Scalar relativistic corrections were calculated by comparing the energies using the spin-free version of the 1e$^-$ X2C (exact 2-component) Hamiltonian \cite{}, to the energies of the NR-CPN Hamiltonian. %The spin-free 1e$^-$ version of the X2C Hamiltonian is equivalent to infinite-order DKH. 
...
\vspace{-4mm}
    ...
    We wish to thank {\color{blue} Mariusz Puchalski, Krzysztof Pachucki, Robert Moszysnki, Jacek Komasa, Gordon Drake, Michal Lesiuk}, and {\color{blue}Michal Przybytek} for helpful discussions, comments and suggestions. 
