    ...
    total electronic energies. For H, the listed energy is exact, since the Hartree
    ...
    $^{3}$Li & Li$^{+}\left(1^{1}S\right)\leftarrow\text{Li}\left(2^{2}S\right)$ & 3~487&159~40(18) & \multicolumn{2}{c}{\cite{Bushaw2007}} & 43~487&159~0(8) & \cite{Puchalski2008} & ~~~-0&000~4 & ~~~~~~2&22 & Experiment\tabularnewline
    ...
    $^{12}$C & C$^{+}\left(2^{2}P\right)\leftarrow\text{C}\left(2^{3}P\right)$ & 90~833&008(009) & \multicolumn{2}{c}{\cite{Haris2017}} & \textcolor{red}{90~832}&\textcolor{red}{014} & - & ~~~0&994 & ~~~~~~110&44 & Experiment\tabularnewline[2mm]
    \hline
    ...
    \hline
    \noalign{\vskip2mm}
    Mean ($\sigma$) &  & -37&844~521~4 & -37&8430~0519~09 & 90~863&037\tabularnewline[2mm]
    \hline
    \end{tabular*}
    \end{table}
    \par\end{center}
    ...
    \subsection{{\scriptsize Estimation of relativistic, QED, and finite nuclear mass corrections corrections}}
