...
\affiliation{Harvard-Smithsonian Center for Astrophysics, Atomic and Molecular Physics Division, 02138, Cambridge, MA, USA,}
...
\affiliation{Adam Mickiewicz University, Department of Chemistry, 60\textendash 780
Poznan, Poland.}
...
\hline 
\noalign{\vskip2mm}
H & H$^+\left(1^1S\right)\leftarrow~$H$\left(1^2S\right) & & & \multicolumn{2}{c}{} & 109~678.77174307 &  &  &  & Theory \tabularnewline
$^{4}$He & He$^+\left(1^2S\right)\leftarrow~$He$\left(1^1S\right) & 198~310&667~2(15) & \multicolumn{2}{c}{\cite{Eikema1997}}  & 198~310.666~8(30) & \cite{Drake2000}  & -0.000~4 & 0.27 & Experiment \tabularnewline
...
$^{12}$C & C$^+\left(2^{2}P\right)\leftarrow~$C$\left(2^{3}P\right)$ & 90~833&008(009) & \multicolumn{2}{c}{\cite{Haris2017}} & \textcolor{red}{{90~832.014(802)}}  & - & 0.994 & 110 &Experiment\tabularnewline[2mm]
\hline 
\end{tabular*}
\end{table*}
\par\end{center}
...
\hline
\noalign{\vskip2mm}
{\scriptsize{}Hamiltonian} &  & \multicolumn{2}{c}{{\scriptsize{}Energy in cm$^{-1}$}} & \multicolumn{2}{c}{\textcolor{black}{\scriptsize{}(Calc - Obs) in cm$^{-1}$}}\tabularnewline[2mm]
\hline
\hline
\noalign{\vskip2mm}
...
\hline
\noalign{\vskip2mm}
Total (theory)Present  & PresentTheory (total) & \textcolor{red} {90~832}&\textcolor{red}{014(802)} & \qquad  -0&994\tabularnewline[2mm]
\hline
\noalign{\vskip2mm}
Experiment 2017  & 2017Experiment \cite{Haris2017}& 90~833&008(009)  & \multicolumn{2}{c}{}\tabularnewline[2mm]
\hline
\noalign{\vskip2mm}
Theory2010 & 2010Theory \cite{Klopper2010}& 90~838&75 & \qquad 5&74\tabularnewline
Theory2017 & 2017Theory \cite{Feller2017}& 90~840&16 & \qquad 7&15\tabularnewline
Theory2015 & 2015Theory \cite{FN-DMC}& 90~786&66  & \qquad -46&35\tabularnewline[2mm]
\hline
\end{tabular*}
}
\end{table}
...
\hline
\noalign{\vskip2mm}
Eq.\eqref{KutzelniggSolved}, $n=\nicefrac{3}{2}$ &  & -37&844~528~6 & -37&430~523~6 & 90~863&604\tabularnewline
...
Table \ref{tab:Summary} summarizes the various contributions to our value of the IE, and compares our final value to experiment and to three recent theoretical estimates. Our value is 0.994\,cm$^{-1}$ smaller than the best experimental value, and estimate of the uncertainty in our value is only 0.802\,cm$^{-1}$. Since we included all known contributions up to the fifth power of the fine structure constant in the QED expansion of the energies, we estimate that the contributions of all terms of sixth power and beyond add up to (0.994$\pm$0.802)\,cm$^{-1}$.
