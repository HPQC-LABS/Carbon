...
\subsection{{\scriptsize Estimation of relativistic, QED, and finite nuclear mass corrections}}
...
together comprise the Lamb shift) from the  state-averaged Dirac-Fock calculations done in \cite{Klopper2010}. The overall contribution from the Breit and QED correctons (combined) to the IE for C was -0.48\,cm$^{-1}$.
