...
in any experiment to date. The valueThe value for carbon of \textcolor{redblue}{90~832.3014(8102)}\,cm$^{-1}$ was calculated in the present work.}
...
$^{12}$C & C$^+\left(2^{2}P\right)\leftarrow~$C$\left(2^{3 }P\right)$ & 90~833.008(009)90~833&11(10) & \multicolumn{2}{c}{90~832.014(802)} & \textcolor{redblue}{90~833.008(009)} &  & 1.076 & 11.08 & Experiment\tabularnewline[2mm]
\hline 
\end{tabular*}
\end{table*}
\par\end{center}
