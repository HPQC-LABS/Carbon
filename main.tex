...
A deterministic FCI calculation were possible for the 5e$^-$ system C$^{+}$ in aug-cc-pCV6Z with about 130$\,$GB of RAM to store the Davidson vectors, but were not possible for the 6e$^-$ neutral C atom in this basis set (which would require almost 9\,TB of RAM), nor for the 5e$^-$ C$^+$ ion in the aug-cc-pCV7Z basis set (which would require almost 55\,TB of RAM, and for the neutral atom would require more). T  

We therefore we use FCIQMC for all NR-CPN calculations. The wavefunction of the relevant system is expanded as a sum
