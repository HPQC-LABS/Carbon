...
$^{12}$C & C$^+\left(2^{2}P\right)\leftarrow~$C$\left(2^{3 }P\right)$ & 90~833.008(009) &   \textcolor{red}{\multicolumn{2}{c}{90~832.014(802)}}  & - & 0.994 & 110 & Experiment\tabularnewline[2mm]
\hline 
\end{tabular*}
\end{table*}
\par\end{center}
