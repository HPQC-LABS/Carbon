...
\begin{tabular*}{1\textwidth}{@{\extracolsep{\fill}}ccr@{\extracolsep{0pt}.}lr@{\extracolsep{0pt}.}lcccc}
\hline
\noalign{\vskip2mm}
 & Transition & \multicolumn{32}{c}{Experiment } & \multicolumn{2}{c}{} & Theory &  & Calc - Obs & $\lvert\frac{\text{Calc - Obs}}{\text{Uncertainty in obs}}\rvert$ & More precise\tabularnewline
 &  & \multicolumn{2}{c}{{[}cm$^{-1}${]}} & \multicolumn{2}{c}{} & {[}cm$^{-1}${]} &  & {[}cm$^{-1}${]} &  & \tabularnewline[2mm]
\hline
\hline
\noalign{\vskip2mm}
$^1$H & H$^+\left(1^1S\right)\leftarrow~$H$\left(1^2S\right)$ & & &   & 109~678.771~743~07(10) \footnote{This number is based on the data in \cite{PhysRevLett.95.163003} although it is not explicitly written anywhere there. Two of the authors of \cite{PhysRevLett.95.163003} have presented the number in Table III of \cite{RevModPhys.88.035009}.} &  &  &  & Theory \tabularnewline
...
$^{12}$C & C$^+\left(2^{2}P\right)\leftarrow~$C$\left(2^{3}P\right)$ & 90~833&008(009) & \cite{Haris2017} & \textcolor{red}{{90~832.014}}  & - & 0.994 &  &Experiment\tabularnewline[2mm]
\hline
\end{tabular*}
\end{table*}
\par\end{center}
